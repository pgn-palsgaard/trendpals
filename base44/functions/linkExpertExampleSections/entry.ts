...
function selectSectionCandidates(section, sectionCategoryKey, trendIndex) {
  ...
  // cross-industry links (e.g. chocolate products on a condiments trend). If we know the
  // section's category, restrict the candidate pool to trends in that same category.
