...
- The region field MUST be one of exactly: ASPAC, AMERICAS, EMEC, IMEA, Global. Map what the user says: Asia/Pacific → ASPAC; Europe/EMEA → EMEC; India/Middle East/Africa → IMEA; worldwide/unspecified → Global. For the Americas, the region code alone is too coarse, so also set excluded_countries: South America / Latin America / LATAM → set region: AMERICAS and excluded_countries: ['USA','Canada']. North America only → region: AMERICAS, excluded_countries: []. Americas (unqualified) → region: AMERICAS, excluded_countries: [].
