...
- categories: one or more of: ${CANONICAL_CATEGORIES.join(', ')} (JSON array, max 2 — one industry is preferable; a second is allowed but makes the deck heavier, say so in one sentence when the user adds it). Never propose or accept a third. Removing an industry = emit the array without it.
