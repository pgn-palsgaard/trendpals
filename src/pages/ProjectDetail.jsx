      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-8 bg-white shadow-sm border border-slate-200/60 p-1.5 rounded-xl h-auto">
            <TabsTrigger 
              value="overview" 
              className="flex items-center gap-2 px-5 py-3 rounded-lg text-slate-600 hover:text-slate-900 data-[state=active]:bg-[#1D428A] data-[state=active]:text-white data-[state=active]:shadow-md transition-all"
            >
